...
namespace OpenAC.Net.Core.Tests
{
    public class CryptoTest
    {
        ...
        public void TripeDesCrypt()
        {
            ...
            Assert.Throws<OpenException>(() => "N9DN1Vek2Gw1nT3hv7JuBA===".Decrypt(Key));
        }
        ...
        public void DesCrypt()
        {
            ...
            Assert.Throws<OpenException>(() => "gp93NTcn4qg88xlB6QSF0A===".Decrypt<DESCryptoServiceProvider>(Key));
        }
        ...
        public void AesCrypt()
        {
            ...
            Assert.Throws<OpenException>(() => "WQ3DZ+pyDepYyUX7UuotMg===".Decrypt<AesCryptoServiceProvider>(Key));
        }
        ...
        public void RijndaelCrypt()
        {
            ...
            Assert.Throws<OpenException>(() => "WQ3DZ+pyDepYyUX7UuotMg===".Decrypt<RijndaelManaged>(Key));
        }
        ...
        public void RC2Crypt()
        {
            ...
            Assert.Throws<OpenException>(() => "Aif7jZ9sARRI4lG2p450hg===".Decrypt<RC2CryptoServiceProvider>(Key));
        }
        ...
        public void AesManagedCrypt()
        {
            ...
            Assert.Throws<OpenException>(() => "WQ3DZ+pyDepYyUX7UuotMg===".Decrypt<AesManaged>(Key));
        }
    }
}